...
namespace ConsoleApp2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.Write($"Периметр прямоугольника = {(a + b) * 2}\nДлина диагонали прямоугольника = {Math.Sqrt(d):f2}");
            //Console.Read();
            ...
            //Console.WriteLine($"Расстояние между точками составляет {Math.Sqrt(Math.Pow((b-a),2) + Math.Pow((d-c),2)):f2}");
            //Console.ReadLine();

            //6.

            //Console.Write("Стоимость 1кг продуктов (руб) = ");
            //double sum = double.Parse(Console.ReadLine());
            //Console.Write("Куплено конфет (кг) = ");
            //double a = double.Parse(Console.ReadLine());
            //Console.Write("Куплено печенья (кг) = ");
            //double b = double.Parse(Console.ReadLine());
            //Console.Write("Куплено яблок (кг) = ");
            //double c = double.Parse(Console.ReadLine());
            //Console.WriteLine($"Стоимость покупки = {(a+b+c)*sum:c}");
            //Console.ReadKey();
        }
    }
}
